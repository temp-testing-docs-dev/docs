...
<Warning>
Important: When configuring your SIP trunk, it is crucial to include all signaling IP addresses. Omitting any of these addresses can lead to whitelisting issues, potentially resulting in unauthorized 401 errors for inbound calls. Always double-check that you've included all necessary IP addresses to ensure smooth operation of your SIP trunk.
</Warning>
