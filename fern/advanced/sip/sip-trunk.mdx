...
<Info>
For inbound calls, the SIP URI format should be: `sip:{phoneNumber}@<credential_id>.sip.vapi.ai`. Make sure to configure this correctly in your SIP provider's settings.
</Info>
